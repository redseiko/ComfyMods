...
public static class UIBuilder {
  ...
  public static TextMeshProUGUI CreateTMPHeaderLabel(Transform parentTransform) {
    TextMeshProUGUI label = UnityEngine.Object.Instantiate(UnifiedPopup.instance.headerText, parentTransform);
    label.name = "Label";
  ...
  public static GuiInputField CreateInputField(Transform parentTransform) {
    GuiInputField inputField = UnityEngine.Object.Instantiate(TextInput.instance.m_inputField, parentTransform);
