...
public static class CodeMatcherExtensions {
  public static readonly CodeMatch ZInputGetButtonDown =
      new(OpCodes.Call, AccessTools.Method(typeof(ZInput), nameof(ZInput.GetButtonDown), [typeof(string)]));

  public static readonly CodeMatch ZInputGetKeyDownMatch =
      new(
          OpCodes.Call,
          AccessTools.Method(typeof(ZInput), nameof(ZInput.GetKeyDown), [typeof(KeyCode), typeof(bool)]));

  public static readonly CodeMatch ZInputGetKeyMatch =
      new(
          OpCodes.Call,
          AccessTools.Method(typeof(ZInput), nameof(ZInput.GetKey), [typeof(KeyCode), typeof(bool)]));
