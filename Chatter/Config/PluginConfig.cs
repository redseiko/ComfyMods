...
public static class PluginConfig {
  ...
  public static void BindConfig(ConfigFile config) {
    ...
    ChatMessageTextDefaultColor.OnSettingChanged(
        static color => ContentRowManager.SetMessageTextColor(color, ChatMessageType.Text));
    ...
    ChatMessageTextSayColor.OnSettingChanged(
        static color => ContentRowManager.SetMessageTextColor(color, ChatMessageType.Say));
    ...
    ChatMessageTextShoutColor.OnSettingChanged(
        static color => ContentRowManager.SetMessageTextColor(color, ChatMessageType.Shout));
    ...
    ChatMessageTextWhisperColor.OnSettingChanged(
        static color => ContentRowManager.SetMessageTextColor(color, ChatMessageType.Whisper));
    ...
    ChatMessageTextPingColor.OnSettingChanged(
        static color => ContentRowManager.SetMessageTextColor(color, ChatMessageType.Ping));
    ...
    ChatMessageTextMessageHudColor.OnSettingChanged(
        static color => ContentRowManager.SetMessageTextColor(color, ChatMessageType.HudCenter));
    ...
    ChatMessageUsernameColor.OnSettingChanged(ContentRowManager.SetUsernameTextColor);
    ...
    ChatMessageTimestampColor.OnSettingChanged(ContentRowManager.SetTimestampTextColor);
  ...
  static void BindFilters(ConfigFile config) {
    ...
    FilterInWorldShoutText =
        config.BindInOrder(
            ...
            "filterInWorldShoutText",
            false,
            "If true, will also filter in-world Shout message texts.");
