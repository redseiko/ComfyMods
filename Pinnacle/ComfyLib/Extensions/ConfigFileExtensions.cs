...
namespace ComfyLib {
  public static class ConfigFileExtensions {
    ...
    public static bool IsDefaultValue<T>(this ConfigEntry<T> configEntry) {
      return EqualityComparer<T>.Default.Equals(configEntry.Value, (T) configEntry.DefaultValue);
    }
